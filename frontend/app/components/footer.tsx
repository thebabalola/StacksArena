      ...
      <div className="mx-auto max-w-7xl px-6 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          <div className="md:col-span-2 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="hidden md:block text-sm text-muted-foreground max-w-xs leading-relaxed">
        ...
        <div className="border-t border-border mt-6 md:mt-8 pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-center md:text-left">
